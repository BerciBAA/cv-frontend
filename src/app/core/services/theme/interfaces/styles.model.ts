...
export const STYLES: Record<'light'|'dark', AppTheme> = {
  light: {
    ...
    input: {
      ...
      border: 'border border-gray-400 focus:border-black focus:ring-1 focus:ring-black'
    },
    label: {
      text: 'text-black',
  ...
  dark: {
    ...
    input: {
      ...
      border: 'border border-gray-600 focus:border-white focus:ring-1 focus:ring-white'
    },
    label: {
      text: 'text-white',
